...
namespace XamarinFormsChatUI.Droid
{
    [Activity(Label = "Xamarin Forms Chat UI", Icon = "@drawable/icon", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
